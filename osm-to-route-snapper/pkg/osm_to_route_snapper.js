...
/**
* @param {string} input_osm
* @param {string} boundary_geojson
* @returns {Uint8Array}
*/
export function convert(input_osm, boundary_geojson) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(input_osm, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('osm_to_route_snapper_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
